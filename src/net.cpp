...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Liazoncoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"liazoncoin.com", "dnsseed.ddns.net"},
    {"liazoncoin.org", "94.237.60.27"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"liazoncointools.com", "testnet-seed.liazoncointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Liazoncoin is probably already running."), addrBind.ToString().c_str());
        else
